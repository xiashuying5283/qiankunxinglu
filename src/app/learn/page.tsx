...
import { ArrowLeft, Compass, BookOpen, Scroll } from 'lucide-react';
import { trigrams, hexagrams } from '@/lib/divination-data';
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-green-900 via-emerald-900 to-teal-900">
      <div className="container mx-auto px-4 py-8">
        {/* 返回按钮 */}
        <Link href="/">
          <Button variant="ghost" className="mb-6 text-green-200 hover:text-green-100 hover:bg-white/10">
                ...
                <div className="space-y-6">
                  ...
                  <Card className="bg-white/10 backdrop-blur-md border-green-300/30">
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <div className="bg-green-900/40 rounded-lg p-6">
                        <h3 className="text-lg font-bold text-green-100 mb-3">爻辞</h3>
                        <div className="space-y-3">
                          {selectedHexagram.lines.map((line, index) => (
                            <div key={index} className="flex items-start gap-3">
                              ...
                              <span className="text-green-200">{line.split('：')[1]}</span>
                            </div>
                          ))}
                        </div>
                      </div>

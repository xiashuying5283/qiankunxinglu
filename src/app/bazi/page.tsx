        ...
        <div className="max-w-4xl mx-auto">
          ...
          {result && (
            <div className="space-y-6">
                ...
                <CardContent>
                  <div className="grid grid-cols-4 gap-4 text-center">
                    {[
                      ...
                      <div key={i} className="bg-[#0a0a0a] rounded-lg p-4 border border-amber-500/20">
                        ...
                        <div className={`text-xs mt-2 ${shiShenColors[item.shishen] || 'text-amber-500'}`}>
                          {item.shishen}
                        </div>
              ...
              {/* 温馨提示 */}
              <div className="bg-[#0a0a0a] rounded-lg p-4 text-center border border-amber-500/20">

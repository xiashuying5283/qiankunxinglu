  ...
  const StarRating = ({ score, max = 5 }: { score: number; max?: number }) => (
    <div className="flex gap-1">
      {Array.from({ length: max }).map((_, i) => (
        <Star
          key={i}
          className={`w-4 h-4 ${i < score ? 'text-[var(--theme-gold)] fill-[var(--theme-gold)]' : 'text-[var(--theme-text-muted)]'}`}
        />
      ))}
    </div>
  );
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center mb-4">
            <Sun className="w-10 h-10 text-[var(--theme-gold)] mr-3" />
            <h1 className="text-4xl font-bold text-[var(--theme-gold)]">每日运势</h1>
            <Sun className="w-10 h-10 text-[var(--theme-gold)] ml-3" />
          </div>
          <p className="text-[var(--theme-text-secondary)]">精确老黄历 · 十二生肖运势 · 今日宜忌</p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          {showZodiacSelector && (
            <Card className="bg-[var(--theme-card)] border-[var(--theme-gold-border)]">
              <CardHeader className="text-center">
                <CardTitle className="text-2xl text-[var(--theme-gold)]">选择您的生肖</CardTitle>
                ...
                <div className="grid grid-cols-4 md:grid-cols-6 gap-3">
                  {zodiacs.map((zodiac) => (
                    <button
                      ...
                      className="flex flex-col items-center p-4 rounded-lg bg-[var(--theme-bg-secondary)] hover:bg-[var(--theme-gold-bg)] transition-all hover:scale-105 border border-[var(--theme-gold-border)] hover:border-[var(--theme-gold)]"
                    >
                      <span className="text-3xl mb-1">{zodiac.emoji}</span>
                      <span className="text-sm text-[var(--theme-text)] font-medium">{zodiac.name}</span>
                    </button>
                  ))}
                </div>
              </CardContent>
          ...
          {selectedZodiac && fortune && huangLi && !showZodiacSelector && (
            <div className="space-y-6">
              {/* 老黄历头部 */}
              <Card className="bg-gradient-to-r from-red-900/30 to-orange-900/30 border-[var(--theme-gold-border)]">
                <CardContent className="py-6">
                  <div className="flex items-center justify-center gap-2 mb-4">
                    <Calendar className="w-6 h-6 text-[var(--theme-gold)]" />
                    <h2 className="text-2xl font-bold text-[var(--theme-gold)]">老黄历</h2>
                  </div>
                  
                  <div className="text-center mb-4">
                    <p className="text-[var(--theme-text)] text-lg">{huangLi.dateStr}</p>
                    <p className="text-[var(--theme-text-secondary)] mt-1 flex items-center justify-center gap-2">
                  ...
                  <div className="text-center mb-4">
                    <div className="flex items-center justify-center gap-3 flex-wrap">
                      <span className="bg-red-900/40 border border-red-500/30 px-3 py-1.5 rounded text-[var(--theme-text)] font-medium">{huangLi.ganZhiYear}</span>
                      <span className="bg-red-900/40 border border-red-500/30 px-3 py-1.5 rounded text-[var(--theme-text)] font-medium">{huangLi.ganZhiMonth}</span>
                      <span className="bg-red-900/40 border border-red-500/30 px-3 py-1.5 rounded text-[var(--theme-text)] font-medium">{huangLi.ganZhiDay}</span>
                    </div>
                  </div>
                  
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-3 text-center">
                    <div className="bg-[var(--theme-bg-secondary)] rounded-lg p-3 border border-[var(--theme-gold-border)]">
                      <p className="text-xs text-[var(--theme-text-muted)] mb-1">值神</p>
                      <p className="font-bold text-[var(--theme-text)]">{huangLi.zhiShen}</p>
                    </div>
                    <div className="bg-[var(--theme-bg-secondary)] rounded-lg p-3 border border-[var(--theme-gold-border)]">
                      <p className="text-xs text-[var(--theme-text-muted)] mb-1">日冲</p>
                      <p className="font-bold text-[var(--theme-text)]">{huangLi.chong}</p>
                    </div>
                    <div className="bg-[var(--theme-bg-secondary)] rounded-lg p-3 border border-[var(--theme-gold-border)]">
                      <p className="text-xs text-[var(--theme-text-muted)] mb-1">日煞</p>
                      <p className="font-bold text-[var(--theme-text)]">{huangLi.sha}</p>
                    </div>
                    <div className="bg-[var(--theme-bg-secondary)] rounded-lg p-3 border border-[var(--theme-gold-border)]">
                      <p className="text-xs text-[var(--theme-text-muted)] mb-1">星宿</p>
                      <p className="font-bold text-[var(--theme-text)]">{huangLi.xingSu}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <Card className="bg-green-900/20 border-green-500/20">
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-2">
                      ...
                      )) : <span className="text-[var(--theme-text-secondary)] text-sm">今日诸事不宜</span>}
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-red-900/20 border-red-500/20">
                  ...
                  <CardContent>
                    <div className="flex flex-wrap gap-2">
                      ...
                      )) : <span className="text-[var(--theme-text-secondary)] text-sm">今日百无禁忌</span>}
                    </div>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card className="bg-[var(--theme-card)] border-[var(--theme-gold-border)]">
                <CardHeader className="pb-2">
                  <CardTitle className="text-lg text-[var(--theme-gold)] flex items-center gap-2">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        )) : <span className="text-[var(--theme-text-secondary)] text-sm">今日无吉时</span>}
                      </div>
                    </div>
                    <div>
                      ...
                      <div className="flex flex-wrap gap-2">
                        ...
                        )) : <span className="text-[var(--theme-text-secondary)] text-sm">今日无凶时</span>}
                      </div>
                    </div>
                  </div>
                </CardContent>
              ...
              <Card className="bg-[var(--theme-card)] border-[var(--theme-gold-border)]">
                <CardHeader className="pb-2">
                  <CardTitle className="text-lg text-[var(--theme-text)] flex items-center gap-2">
                ...
                <CardContent>
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-3 text-center">
                    <div className="bg-amber-900/20 rounded-lg p-3 border border-amber-500/20">
                      <p className="text-xs text-[var(--theme-text-muted)] mb-1">财神</p>
                    ...
                    <div className="bg-indigo-900/20 rounded-lg p-3 border border-indigo-500/20">
                      <p className="text-xs text-[var(--theme-text-muted)] mb-1">福神</p>
                    ...
                    <div className="bg-pink-900/20 rounded-lg p-3 border border-pink-500/20">
                      <p className="text-xs text-[var(--theme-text-muted)] mb-1">喜神</p>
                    ...
                    <div className="bg-blue-900/20 rounded-lg p-3 border border-blue-500/20">
                      <p className="text-xs text-[var(--theme-text-muted)] mb-1">阳贵</p>
                    ...
                    <div className="bg-orange-900/20 rounded-lg p-3 border border-orange-500/20">
                      <p className="text-xs text-[var(--theme-text-muted)] mb-1">太阴</p>
              ...
              <Card className="bg-[var(--theme-card)] border-[var(--theme-gold-border)]">
                <CardContent className="py-6">
                  <div className="text-center mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-[var(--theme-gold)]">{fortune.zodiac.name}生肖今日运势</h2>
                    ...
                    <label className="flex items-center justify-center gap-2 mt-3 cursor-pointer">
                      <input
                        ...
                        className="w-4 h-4 rounded border-[var(--theme-gold-border)] bg-[var(--theme-bg-secondary)]"
                      />
                      <span className="text-sm text-[var(--theme-text-secondary)] flex items-center gap-1">
                  ...
                  <div className="text-center">
                    <div className="inline-block bg-[var(--theme-gold)] px-6 py-3 rounded-lg">
                  ...
                  <CardContent className="py-5">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-[var(--theme-text)]">事业运</span>
                      </div>
                      <StarRating score={fortune.careerScore} />
                    </div>
                    <p className="text-[var(--theme-text-secondary)] text-sm">{fortune.career}</p>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="py-5">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-[var(--theme-text)]">爱情运</span>
                      </div>
                      <StarRating score={fortune.loveScore} />
                    </div>
                    <p className="text-[var(--theme-text-secondary)] text-sm">{fortune.love}</p>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="py-5">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-[var(--theme-text)]">财运</span>
                      </div>
                      <StarRating score={fortune.wealthScore} />
                    </div>
                    <p className="text-[var(--theme-text-secondary)] text-sm">{fortune.wealth}</p>
                  </CardContent>
                </Card>
                  ...
                  <CardContent className="py-5">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="font-bold text-[var(--theme-text)]">健康运</span>
                      </div>
                      <StarRating score={fortune.healthScore} />
                    </div>
                    <p className="text-[var(--theme-text-secondary)] text-sm">{fortune.health}</p>
                  </CardContent>
                </Card>
              </div>
              ...
              <Card className="bg-[var(--theme-card)] border-[var(--theme-gold-border)]">
                <CardHeader className="pb-2">
                  <CardTitle className="text-lg text-[var(--theme-gold)] flex items-center gap-2">
                    <Sparkles className="w-5 h-5 text-[var(--theme-gold)]" /> 今日幸运元素
                  </CardTitle>
                </CardHeader>
                <CardContent>
                  <div className="grid grid-cols-3 md:grid-cols-5 gap-3 text-center">
                    <div className="bg-[var(--theme-bg-secondary)] rounded-lg p-4 border border-[var(--theme-gold-border)]">
                      <div className="text-2xl mb-1">🎨</div>
                      <div className="text-xs text-[var(--theme-text-muted)] mb-1">幸运颜色</div>
                      <div className="font-bold text-[var(--theme-text)]">{fortune.luckyColor}</div>
                    </div>
                    <div className="bg-[var(--theme-bg-secondary)] rounded-lg p-4 border border-[var(--theme-gold-border)]">
                      <div className="text-2xl mb-1">🔢</div>
                      <div className="text-xs text-[var(--theme-text-muted)] mb-1">幸运数字</div>
                      <div className="font-bold text-[var(--theme-text)]">{fortune.luckyNumber}</div>
                    </div>
                    <div className="bg-[var(--theme-bg-secondary)] rounded-lg p-4 border border-[var(--theme-gold-border)]">
                      <div className="text-2xl mb-1">🧭</div>
                      <div className="text-xs text-[var(--theme-text-muted)] mb-1">幸运方位</div>
                      <div className="font-bold text-[var(--theme-text)]">{fortune.luckyDirection}</div>
                    </div>
                    <div className="bg-[var(--theme-bg-secondary)] rounded-lg p-4 border border-[var(--theme-gold-border)]">
                      <div className="text-2xl mb-1">⭐</div>
                      <div className="text-xs text-[var(--theme-text-muted)] mb-1">星座</div>
                      <div className="font-bold text-[var(--theme-text)]">{huangLi.xingZuo}</div>
                    </div>
                    <div className="bg-[var(--theme-bg-secondary)] rounded-lg p-4 border border-[var(--theme-gold-border)]">
                      <div className="text-2xl mb-1">🌟</div>
                      <div className="text-xs text-[var(--theme-text-muted)] mb-1">纳音</div>
                      <div className="font-bold text-[var(--theme-text)] text-sm">{huangLi.naYin.split(' ')[2]}</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
              ...
              {/* 彭祖百忌 */}
              <Card className="bg-amber-900/20 border-[var(--theme-gold-border)]">
                <CardContent className="py-4">
                  <h4 className="font-bold text-[var(--theme-gold)] mb-2 flex items-center gap-2">
                    <span>📜</span> 彭祖百忌
                  </h4>
              ...
              <Card className="bg-indigo-900/20 border-indigo-500/20">
                <CardContent className="py-4">
                  ...
                  <p className="text-[var(--theme-text-secondary)] text-sm leading-relaxed">{huangLi.erShiBaXiu}</p>
                </CardContent>
              </Card>

              {/* 今日建议 */}
              <Card className="bg-gradient-to-r from-amber-900/20 to-orange-900/20 border-[var(--theme-gold-border)]">
                <CardContent className="py-4">
                  <h4 className="font-bold text-[var(--theme-gold)] mb-2 flex items-center gap-2">
                    <span>💡</span> 今日建议
                  </h4>
                  <p className="text-[var(--theme-text-secondary)]">{fortune.advice}</p>
                </CardContent>
              </Card>
              ...
              <div className="text-center pt-4">
                <Button
                  onClick={handleReset}
                  className="bg-[var(--theme-gold)] hover:opacity-90 text-black px-8 py-2 font-medium"
                >
                  选择其他生肖
                </Button>
              </div>

        ...
        <div className="max-w-6xl mx-auto">
          <Tabs defaultValue="basics" className="space-y-6">
            <TabsList className="grid w-full grid-cols-3 bg-card border border-amber-500/20">
              <TabsTrigger value="basics" className="data-[state=active]:bg-amber-500/20 data-[state=active]:text-amber-500 text-muted-foreground">
                <BookOpen className="w-4 h-4 mr-2" />
                基础知识
              </TabsTrigger>
              <TabsTrigger value="major" className="data-[state=active]:bg-amber-500/20 data-[state=active]:text-amber-500 text-muted-foreground">
                <Sparkles className="w-4 h-4 mr-2" />
                大阿卡纳
              </TabsTrigger>
              <TabsTrigger value="spread" className="data-[state=active]:bg-amber-500/20 data-[state=active]:text-amber-500 text-muted-foreground">
            ...
            <TabsContent value="basics">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="bg-card/50 border-amber-500/20">
                  <CardHeader>
                    <CardTitle className="text-xl text-amber-500">塔罗牌简介</CardTitle>
                  </CardHeader>
                ...
                <Card className="bg-card/50 border-amber-500/20">
                  <CardHeader>
                    <CardTitle className="text-xl text-amber-500">大阿卡纳</CardTitle>
                  </CardHeader>
                  <CardContent className="text-muted-foreground leading-relaxed">
                    <p className="mb-4">
                ...
                <Card className="bg-card/50 border-amber-500/20">
                  <CardHeader>
                    <CardTitle className="text-xl text-amber-500">小阿卡纳</CardTitle>
                  </CardHeader>
                  <CardContent className="text-muted-foreground leading-relaxed">
                    <p className="mb-4">
                    ...
                    <div className="space-y-2 text-sm">
                      <p><strong className="text-amber-400">权杖：</strong>火元素，象征行动、热情</p>
                      <p><strong className="text-amber-400">圣杯：</strong>水元素，象征情感、直觉</p>
                      <p><strong className="text-amber-400">宝剑：</strong>风元素，象征思维、沟通</p>
                      <p><strong className="text-amber-400">星币：</strong>土元素，象征物质、财富</p>
                    </div>
                  </CardContent>
                </Card>
                ...
                <Card className="bg-card/50 border-amber-500/20">
                  <CardHeader>
                    <CardTitle className="text-xl text-amber-500">正位与逆位</CardTitle>
                  </CardHeader>
                  <CardContent className="text-muted-foreground leading-relaxed">
                    <p className="mb-4">
                      塔罗牌在占卜时有两种状态：
                    ...
                    <div className="space-y-2">
                      <p><strong className="text-amber-400">正位：</strong>牌的基本含义和积极面向</p>
                      <p><strong className="text-amber-400">逆位：</strong>相反或被阻碍的含义</p>
                    </div>
                  </CardContent>
                </Card>

                <Card className="bg-card/50 border-amber-500/20 md:col-span-2">
                  <CardHeader>
                    <CardTitle className="text-xl text-amber-500">四大元素</CardTitle>
                  </CardHeader>
                  <CardContent className="text-muted-foreground leading-relaxed">
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                      <div className="text-center">
                        ...
                        <h4 className="font-bold text-amber-400 mb-1">火元素</h4>
                        <p className="text-sm text-muted-foreground">权杖牌组 · 热情行动</p>
                      </div>
                      <div className="text-center">
                        ...
                        <h4 className="font-bold text-amber-400 mb-1">水元素</h4>
                        <p className="text-sm text-muted-foreground">圣杯牌组 · 情感直觉</p>
                      </div>
                      <div className="text-center">
                        ...
                        <h4 className="font-bold text-amber-400 mb-1">风元素</h4>
                        <p className="text-sm text-muted-foreground">宝剑牌组 · 思维沟通</p>
                      </div>
                      <div className="text-center">
                        ...
                        <h4 className="font-bold text-amber-400 mb-1">土元素</h4>
                        <p className="text-sm text-muted-foreground">星币牌组 · 物质财富</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
              ...
              {selectedCard ? (
                    ...
                    <CardContent className="space-y-6">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="bg-card rounded-lg p-6">
                          <h3 className="text-lg font-bold text-amber-500 mb-3">正位含义</h3>
                          <p className="text-muted-foreground">{selectedCard.upright}</p>
                        </div>
                        <div className="bg-card rounded-lg p-6">
                          <h3 className="text-lg font-bold text-amber-500 mb-3">逆位含义</h3>
                          <p className="text-muted-foreground">{selectedCard.reversed}</p>
                        </div>
                      </div>

                      <div className="bg-card rounded-lg p-6">
                        <h3 className="text-lg font-bold text-amber-500 mb-3">关键词</h3>
                      ...
                      <div className="bg-card rounded-lg p-6">
                        <h3 className="text-lg font-bold text-amber-500 mb-3">牌意解读</h3>
                        <p className="text-muted-foreground leading-relaxed">{selectedCard.description}</p>
                      </div>
                    </CardContent>
                  </Card>
                </div>
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                  {majorArcana.map((card) => (
                    <Card
                      key={card.id}
                      className="bg-card/50 border-amber-500/20 hover:border-indigo-500/40 hover:bg-card cursor-pointer transition-all hover:scale-105"
                    ...
                    >
                      <CardContent className="py-6 text-center">
                        ...
                        <div className="text-sm font-medium text-amber-500">{card.name}</div>
                      </CardContent>
                    </Card>
                  ))}
                </div>
            ...
            <TabsContent value="spread">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <Card className="bg-card/50 border-amber-500/20">
                  <CardHeader>
                    <CardTitle className="text-xl text-amber-500">单张牌占卜</CardTitle>
                    <CardDescription className="text-muted-foreground">最简单的牌阵</CardDescription>
                  </CardHeader>
                  <CardContent className="text-muted-foreground leading-relaxed">
                ...
                <Card className="bg-card/50 border-amber-500/20">
                  <CardHeader>
                    <CardTitle className="text-xl text-amber-500">三张牌占卜</CardTitle>
                    <CardDescription className="text-muted-foreground">时间线牌阵</CardDescription>
                  </CardHeader>
                  <CardContent className="text-muted-foreground leading-relaxed">
                ...
                <Card className="bg-card/50 border-amber-500/20 md:col-span-2">
                  <CardHeader>
                    <CardTitle className="text-xl text-amber-500">占卜注意事项</CardTitle>
                  </CardHeader>
                  <CardContent className="text-muted-foreground leading-relaxed">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">

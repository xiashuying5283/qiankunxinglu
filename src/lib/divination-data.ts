...
export const majorArcana: TarotCard[] = [
  ...
  { id: 3, name: '女皇', arcana: 'major', upright: '丰饶、母性、创造、自然', reversed: '依赖、空虚、过度保护', keywords: ['丰饶', '母性', '创造', '自然'], description: '女皇象征着生命的创造力和丰饶，她代表大地之母的形象。', image: '/tarot/empress.png' },
  { id: 4, name: '皇帝', arcana: 'major', upright: '权威、结构、控制、父亲形象', reversed: '专制、僵化、过度控制', keywords: ['权威', '结构', '控制', '领导'], description: '皇帝代表秩序、权威和物质世界的统治者。', image: '/tarot/emperor.png' },
  { id: 5, name: '教皇', arcana: 'major', upright: '传统、信仰、精神指导、婚姻', reversed: '叛逆、颠覆、新观点', keywords: ['传统', '信仰', '指导', '婚姻'], description: '教皇象征着精神上的指引和传统的智慧。', image: '/tarot/hierophant.png' },
  { id: 6, name: '恋人', arcana: 'major', upright: '爱情、和谐、选择、价值观', reversed: '不和谐、失衡、错误选择', keywords: ['爱情', '和谐', '选择', '关系'], description: '恋人牌代表爱情关系，也象征着人生中的重要抉择。', image: '/tarot/lovers.png' },
  { id: 7, name: '战车', arcana: 'major', upright: '意志力、决心、成功、行动', reversed: '失控、侵略、缺乏方向', keywords: ['意志', '胜利', '决心', '行动'], description: '战车象征着通过决心和意志力取得胜利。', image: '/tarot/chariot.png' },
  { id: 8, name: '力量', arcana: 'major', upright: '勇气、耐心、内在力量、同情心', reversed: '自我怀疑、软弱、缺乏自信', keywords: ['力量', '勇气', '耐心', '内在力量'], description: '力量牌代表内在的勇气和以柔克刚的智慧。', image: '/tarot/strength.png' },
  { id: 9, name: '隐士', arcana: 'major', upright: '内省、寻求真理、孤独、指导', reversed: '孤立、孤独、退缩', keywords: ['内省', '寻求', '智慧', '独处'], description: '隐士代表着向内寻求答案和真理的旅程。', image: '/tarot/hermit.png' },
  ...
  { id: 11, name: '正义', arcana: 'major', upright: '公正、真理、法律、平衡', reversed: '不公正、不诚实、缺乏责任感', keywords: ['正义', '真理', '法律', '平衡'], description: '正义牌代表公平、真理和因果法则。', image: '/tarot/justice.png' },
  { id: 12, name: '倒吊人', arcana: 'major', upright: '牺牲、放手、新视角、等待', reversed: '拖延、抵抗、无谓牺牲', keywords: ['牺牲', '等待', '新视角', '放手'], description: '倒吊人象征着通过牺牲和等待获得新的洞见。', image: '/tarot/hanged-man.png' },
  { id: 13, name: '死神', arcana: 'major', upright: '结束、转变、过渡、放手', reversed: '抵抗改变、停滞、无法放手', keywords: ['结束', '转变', '新生', '过渡'], description: '死神牌代表旧事物的结束和新生活的开始，而非字面上的死亡。', image: '/tarot/death.png' },
  { id: 14, name: '节制', arcana: 'major', upright: '平衡、调和、耐心、适度', reversed: '失衡、过度、缺乏长远眼光', keywords: ['平衡', '调和', '耐心', '适度'], description: '节制牌象征着平衡、调和与中庸之道。', image: '/tarot/temperance.png' },
  { id: 15, name: '恶魔', arcana: 'major', upright: '束缚、诱惑、物质主义、阴影自我', reversed: '解脱、打破束缚、面对阴影', keywords: ['束缚', '诱惑', '物质', '欲望'], description: '恶魔牌代表我们内心的阴影和需要克服的束缚。', image: '/tarot/devil.png' },
  { id: 16, name: '塔', arcana: 'major', upright: '突然改变、崩溃、启示、觉醒', reversed: '避免灾难、恐惧改变、延迟崩溃', keywords: ['改变', '崩溃', '觉醒', '解放'], description: '塔牌象征着旧结构的崩塌和必要的改变。', image: '/tarot/tower.png' },
  { id: 17, name: '星星', arcana: 'major', upright: '希望、灵感、宁静、重生', reversed: '绝望、缺乏信心、失去希望', keywords: ['希望', '灵感', '宁静', '重生'], description: '星星牌代表黑暗过后的希望和指引。', image: '/tarot/star.png' },
  { id: 18, name: '月亮', arcana: 'major', upright: '幻象、恐惧、焦虑、潜意识', reversed: '释放恐惧、压抑情绪、混乱', keywords: ['幻象', '直觉', '恐惧', '潜意识'], description: '月亮牌象征着不确定性和内心的恐惧与幻象。', image: '/tarot/moon.png' },
  ...
  { id: 20, name: '审判', arcana: 'major', upright: '觉醒、重生、召唤、宽恕', reversed: '自我怀疑、拒绝召唤、逃避审判', keywords: ['觉醒', '重生', '召唤', '宽恕'], description: '审判牌象征着生命的觉醒和新的召唤。', image: '/tarot/judgement.png' },
  { id: 21, name: '世界', arcana: 'major', upright: '完成、成就、旅行、圆满', reversed: '未完成、缺乏闭合、寻求闭合', keywords: ['完成', '成就', '圆满', '成功'], description: '世界牌代表一个循环的完成和目标的达成。', image: '/tarot/world.png' },
];
